...
CREATE TABLE `account` (
  ...
  `aignature` varchar(255) default NULL,
...
insert  into `user`(`user_id`,`username`,`password`,`email`,`email_verify`,`account_id`,`create_at`,`update_at`) values (45,'healen','dce0fe7698ca225764ab4096f06d0c1d','449422301@qq.com',1,NULL,'2016-03-14 15:26:09',NULL);
