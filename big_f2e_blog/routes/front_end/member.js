...
router
	...
	.post("/login",function(req,res){
		...
		if(!reg.username.test(loginData.username)){
			...
			var $sql="SELECT user_id,username,password,email_verify,email FROM user WHERE username='"+insertData.username+"' AND password='"+insertData.password+"'"
	 ...
	 *找回密码
	 */
	.get("/forgetpass",function(req,res){
